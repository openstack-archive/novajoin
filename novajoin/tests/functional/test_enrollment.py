...
class TestEnrollment(testtools.TestCase):
    ...
    @oslo_service.loopingcall.RetryDecorator(50, 5, 5, (
    ...
    @oslo_service.loopingcall.RetryDecorator(100, 5, 5, (AssertionError,))
    def _check_ipa_client_created(self):
        self.assertTrue(
            self.ipaclient.find_host(TEST_INSTANCE + EXAMPLE_DOMAIN))

    @oslo_service.loopingcall.RetryDecorator(50, 5, 5, (AssertionError,))
    ...
    def test_enroll_server(self):
        self._create_server()
        # TODO(xek): self._check_ipa_client_install()

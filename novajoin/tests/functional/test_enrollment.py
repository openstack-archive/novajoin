...
class TestEnrollment(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self._conn = openstack.connect(
            ...
            username='demo', password='supersecret')
    ...
    def _create_server(self):
        ...
        return self._conn.compute.wait_for_server(self._server)
    ...
    def _ssh_connect(self):
        ...
        client.connect(
            self._ip.floating_ip_address, username=TEST_IMAGE_USER, pkey=pkey)
        return client
    ...
    def _check_ipa_client_install(self):
        ...
        while tries:
            ...
            if data.get("v1", {}).get("datasource"):
                continue  # wait for cloud-init to finish
    ...
    def test_enroll_server(self):
        ...
        # TODO: check that it was deleted from freeipa

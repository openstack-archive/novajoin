...
class IPANovaJoinBase(object):
    ...
    def __get_connection(self):
        ...
        while tries <= self.ntries:
            ...
            try:
                ...
                # ping to force an actual connection in case there is only one IPA master
                api.Command[u'ping']()
            except (errors.CCacheError, errors.TicketExpired, errors.KerberosError) as e:
    ...
    def _call_ipa(self, command, *args, **kw):
        ...
        try:
            ...
            LOG.debug(result)
            return result
        except (errors.CCacheError, errors.TicketExpired, errors.KerberosError):
